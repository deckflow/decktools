...
- `sdks/typescript` - `@deckflow/decktools-sdk`、ファイルアップロードとタスク API 用の Node.js とブラウザ対応の TypeScript SDK。
...
`@deckflow/decktools-sdk` API は [sdks/typescript/README.ja.md](sdks/typescript/README.ja.md) を参照。
